...
module.exports = function (app, config, passport) {
    ...
    i18n.init(config.i18n, function(){
		i18n.addRoute('/:lng/route.about', ['dev', 'pt'], app, 'get', home.about);
		i18n.addRoute('/:lng/route.tutorial', ['dev', 'pt'], app, 'get', home.tutorial);
		i18n.addRoute('/:lng/route.terms-of-use', ['dev', 'pt'], app, 'get', home.terms);
    });
